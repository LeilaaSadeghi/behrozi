...
document.getElementById('noun1').addEventListener('click', (event) => {
  event.target.innerText = randomMember(getWords2('WORD'));

});

document.getElementById('night').addEventListener('click', (event) => {
  let element_background = document.getElementById('background');
  element_background.style.color = '#cccccc';
  element_background.style.backgroundColor = '#ffff66';
...
document.getElementById('day').addEventListener('click', (event) => {
  let element_background2 = document.getElementById('background');
  element_background2.style.color = '#000000';
  element_background2.style.backgroundColor = '#ffff33';
